# Metasploitable2 – Attack & Defense Lab

This repository documents a series of practical attacks and defenses performed
against the intentionally vulnerable **Metasploitable2** machine, using **Kali Linux**
as the attacking host.
